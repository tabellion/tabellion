...
if ($i_nb_liasses>0) {
	...
	foreach ($a_liasses as $a_liasse) {
		list($i_mev, $st_cote_liasse, $st_nom_notaire, $st_prenom_notaire, $st_commentaire, $st_date_tri, $st_libelle_annees, 
	...
	$pagination = new PaginationTableau(basename(__FILE__),'num_page',count($a_tableau),NB_LIGNES_PAR_PAGE,DELTA_NAVIGATION,
