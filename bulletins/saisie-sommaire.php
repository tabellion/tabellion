	...
	<script type='text/javascript'>
		$(document).ready(function() {
			$("#annuler").click(function() {
				window.location.href = 'saisie-sommaire.php';
			});
...
<body>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">Mise à jour du sommaire des bulletins</div>
		<div class="panel-body">
			...
			<?php switch ($gst_mode) {
				...
				case 'CREATION':
					...
					break;
				default:
					print("<div class=\"alert alert-danger\">Mode inconnu $gst_mode</div>");
			} ?>
		</div>
	</div>
</body>
