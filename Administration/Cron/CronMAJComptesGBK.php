...
require_once '/var/www/clients/client1/web3/web/Commun/Adherent.php';
require_once '/var/www/clients/client1/web3/web/Commun/Courriel.php';

set_include_path('/var/www/clients/client1/web3/web/v4');
