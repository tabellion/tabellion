...
function menu_liste($rconnexionBD)
{
   ...
   {        
      $pagination = new PaginationTableau(basename(__FILE__),'num_page',$rconnexionBD->nb_lignes(),NB_LIGNES_PAR_PAGE,DELTA_NAVIGATION,array('Nom époux','Prénom époux','Nom épouse','Prénom épouse','Date du contrat','Modifier'));
