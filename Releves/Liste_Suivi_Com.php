...
function menu_liste($sconnexionBD)
{
   ...
   {        
      $pagination = new PaginationTableau(basename(__FILE__),'num_page',$sconnexionBD->nb_lignes(),NB_LIGNES_PAR_PAGE,DELTA_NAVIGATION,array('Commune','Releveur','Fourchette','Collection','Fourchette envoyée','Date envoi', 'Retour envoi'));
