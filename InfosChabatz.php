...
print("<div>Ce relev&eacute; de mariage a �t� depos&eacute; par une autre association:<br></div");
...
print("<div><br>Pour en savoir plus, vous �tes invit&eacute;s � rentrer en contact directement avec:<br></div>");
