...
<script type='text/javascript'>
	$(document).ready(function() {
		...
		$("#majLienPubli").validate({
			rules: {
				idf_publication: {
					lien_publi_select: true
				}
			},
			messages: {
				idf_publication: {
					lien_publi_select: "Sélectionner une publication papier"
				}
			}
		});
		...
		$("#majProgram").validate({
			rules: {
				idf_intervenant: {
					intervenant_priorite_program: true
				},
				date_creation: {
					format_date: true
				},
			...
			messages: {
				idf_intervenant: {
					intervenant_priorite_program: "Indiquer au moins l'intervenant, la priorité ou le type de programmation"
				},
				date_creation: {
					format_date: "La date est incorrecte. Attendu : jj/mm/aaaa"
				},
...
switch ($gst_mode) {
	...
	case 'VERIFIER_GROUPE_RELEVE': {
			...
			menu_confirmer_groupe_releve(
				$connexionBD,
				$_SESSION['groupe']['cotes'],
				$_SESSION['groupe']['numeros'],
				$a_releveur,
				$_SESSION['groupe']['idf_releveur'],
				$_SESSION['groupe']['date_fin_releve'],
				$_SESSION['groupe']['publi_num'],
				$_SESSION['groupe']['info_compl']
			);
			break;
		}
