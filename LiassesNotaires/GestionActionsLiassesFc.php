<?php
function menu_liste($pconnexionBD){					/*	Affiche la liste des liasses
	...
	if ($i_nb_liasses!=0)
	{        
		$pagination = new PaginationTableau(basename(filter_input(INPUT_SERVER, 'SCRIPT_NAME', FILTER_SANITIZE_STRING)),'num_page',$i_nb_liasses,
		                                    10,DELTA_NAVIGATION,
...
function menu_liste_releve($pconnexionBD){			/*	Affiche la liste des relevés d'une liasse
															@param object	$pconnexionBD				*/ 
	global $gi_num_page_cour;
...
function menu_liste_publication($pconnexionBD){		/*	Affiche la liste des publications papier d'une liasse
															@param object	$pconnexionBD		*/ 
	global $gi_num_page_cour;
...
function menu_liste_photo($pconnexionBD){			/*	Affiche la liste des photos d'une liasse
															@param object	$pconnexionBD		*/ 
...
function menu_liste_program($pconnexionBD){			/*	Affiche la liste des programmations d'une liasse
															@param object	$pconnexionBD		*/ 
...
function menu_gerer($pconnexionBD){					/*	Affiche le menu des actions sur une liasse
...
function menu_edition_releve($pconnexionBD, $pa_releveur, $pi_idf_releve, $pi_idf_releveur,
                             $pst_date_fin_releve, $pi_publication_numerique, $pst_info_compl){	/*	Affiche de la table d'édition d'un relevé
															@param object	$pconnexionBD				Identifiant de la connexion de base
...
function menu_modifier_releve($pconnexionBD, $pi_idf_releve, $pa_releveur){	/*	 Affiche le menu de modification d'un relevé
															@param object	$pconnexionBD		Identifiant de la connexion de base
...
function menu_ajouter_releve($pconnexionBD, $pa_releveur){	/*	Affiche le menu d'ajout d'un relevé
															@param object	$pconnexionBD		Identifiant de la connexion de base
															@param array		$pa_releveur		Tableau des releveurs		*/ 
...
function menu_ajouter_groupe_releve($pconnexionBD, $pa_releveur){	/*	Affiche le menu d'ajout d'un relevé sur un groupe de liasses
															@param object	$pconnexionBD		Identifiant de la connexion de base
															@param array		$pa_releveur		Tableau des releveurs		*/ 
...
function menu_confirmer_groupe_releve($pconnexionBD, $pa_cotes, $pst_numeros, $pa_releveur, $pi_idf_releveur, 
									  $pst_date_fin_releve, $pst_publi_num, $pst_info_compl){
	...
	if ($i_nb_liasses!=0)
	{        
		$pagination = new PaginationTableau(basename(filter_input(INPUT_SERVER, 'SCRIPT_NAME', FILTER_SANITIZE_STRING)),'num_page_grp_rel',$i_nb_liasses,
		                                    10,DELTA_NAVIGATION,array('Cote','Nom notaire','Prénom','Commune','Commentaire',
...
/** --------------------------------------- publication papier ----------------------------------- **/
function menu_edition_lien_publication($pconnexionBD, $pa_publication, $pi_idf_publication){	/*	Affiche de la table d'édition d'un lien publication papier
														@param object	$pconnexionBD				Identifiant de la connexion de base
...
function menu_modifier_lien_publication($pconnexionBD, $pi_idf_lien_publication, $pa_publication){	/*	Affiche le menu de modification d'un lien publication papier
															@param object	$pconnexionBD		Identifiant de la connexion de base
...
function menu_ajouter_lien_publication($pconnexionBD, $pa_publication){			/*	Affiche le menu d'ajout d'un lien publication papier
															@param object		$pconnexionBD		Identifiant de la connexion de base
															@param array		$pa_publication		Tableau des publications papier		*/ 
...
function menu_edition_photo($pconnexionBD, $pa_reveleur, $pi_idf_photo, $pi_idf_photographe, $pst_date_photo, $pi_couverture_photo, 
							$pi_codif_photo, $pst_info_compl, $pa_couverture_photo, $pa_codif_photo){ /*		Affiche de la table d'édition d'une photo
															@param object	$pconnexionBD				Identifiant de la connexion de base
...
function menu_modifier_photo($pconnexionBD, $pi_idf_photo, $pa_reveleur, $pa_couverture_photo, $pa_codif_photo){	/*	Affiche le menu de modification d'une photo
															@param object	$pconnexionBD		Identifiant de la connexion de base
															@param integer	$pi_idf_photo		Identifiant de la prise de photo à modifier 
															@param array	$pa_reveleur		Tableau des releveurs		*/ 
...
function menu_ajouter_photo($pconnexionBD, $pa_reveleur, $pa_couverture_photo, $pa_codif_photo){	/*		Affiche le menu d'ajout d'une photo
															@param object	$pconnexionBD		Identifiant de la connexion de base
															@param array	$pa_reveleur		Tableau des releveurs		*/ 
...
function menu_edition_program($pconnexionBD, $pa_reveleur, $pi_idf_program, $pi_idf_intervenant, $pi_priorite_program, 
							  ...
							  $pi_program_releve, $pi_program_photo, $pst_info_compl, $pa_priorite_program){	/*	Affiche de la table d'édition d'une programmation
															@param object	$pconnexionBD				Identifiant de la connexion de base
															@param array		$pa_reveleur				Tableau des releveurs
...
function menu_modifier_program($pconnexionBD, $pi_idf_program, $pa_reveleur, $pa_priorite_program){		/*	Affiche le menu de modification d'une programmation
															@param object	$pconnexionBD			Identifiant de la connexion de base
															@param integer	$pi_idf_program			Identifiant de la programmation à modifier 
															@param array	$pa_reveleur			Tableau des releveurs
...
function menu_ajouter_program($pconnexionBD, $pa_reveleur, $pa_priorite_program){		/*	Affiche le menu d'ajout d'une programmation
															@param object		$pconnexionBD			Identifiant de la connexion de base
															@param array		$pa_reveleur			Tableau des releveurs
...
function menu_ajouter_releveur($pconnexionBD){		/*	Affiche le menu d'ajout d'un releveur ou d'un photographe
															@param object	$pconnexionBD		Identifiant de la connexion de base		*/ 
...
function escape_apostrophe($pst_texte){				/*	Elimine les éventuels \ du texte et remplace les ' par \'
...
function extraction_liste($st_chaine, $st_serie) {		/*	Extrait un tableau de cotes à partir d'une liste de numéros et d'une série de liasse
