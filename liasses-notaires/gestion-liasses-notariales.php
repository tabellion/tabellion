...
require_once('gestion-liasses-notariales-fc.php');
require_once('gestion-liasses-notariales-fc-periodes.php');
require_once('gestion-liasses-notariales-fc-notaires.php');
switch ($gst_mode) {
	case 'LISTE': {
