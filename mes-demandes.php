...
{
    if ($pi_nb_ddes != 0) {
        return "<a href=\"/MesDemandes.php?mode=VUE_DEMANDES_COMMUNE&idf_commune=$pi_idf_commune&idf_type_acte=$pi_idf_type_acte\">$pi_nb_ddes</a>";
    } else {
        return $pi_nb_ddes;
    }
}
...
{
    if ($pi_nb_ddes != 0) {
        return "<a href=\"/MesDemandes.php?mode=VUE_DEMANDES_MOIS_ANNNEE&mois=$pi_mois&annee=$pi_annee&idf_type_acte=$pi_idf_type_acte\">$pi_nb_ddes</a>";
    } else {
        return $pi_nb_ddes;
    }
}
