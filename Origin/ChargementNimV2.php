            ...
            if ($b_acte_nexistepas) {
                ...
                if ($st_cjt_intv1 != '') {
                    ...
                    if (preg_match("/^\(*Veuf\)*$/i", $st_cjt_intv1) || $st_cjt_intv1 == '?' || $st_cjt_intv1 == '!')
                        ...
                        switch ($c_sexe_intv1) {
                            case 'M':
                                $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $intv1->getIdf(), $st_nom_intv1, $cjt_intv1->getIdf(), $st_nom_cjt_intv1);
                                break;
                            case 'F':
                                $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $cjt_intv1->getIdf(), $st_nom_cjt_intv1, $intv1->getIdf(), $st_nom_intv1);
                                break;
                            default:
                                $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $intv1->getIdf(), $st_nom_intv1, $cjt_intv1->getIdf(), $st_nom_cjt_intv1);
                        }
                ...
                if ($st_nom_intv2 != '') {
                    ...
                    if ($st_cjt_intv2 != '') {
                        ...
                        if (preg_match("/^\(*Veuve\)*$/i", $st_cjt_intv2) || $st_cjt_intv2 == '?' || $st_cjt_intv2 == '!')
                            ...
                            switch ($c_sexe_intv2) {
                                case 'M':
                                    $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $intv2->getIdf(), $st_nom_intv2, $cjt_intv2->getIdf(), $st_nom_cjt_intv2);
                                    break;
                                case 'F':
                                    $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $cjt_intv2->getIdf(), $st_nom_cjt_intv2, $intv2->getIdf(), $st_nom_intv2);
                                    break;
                                default:
                                    $union->ajoute($pi_idf_source, $pi_idf_commune, $i_acte, $st_type_acte, $intv2->getIdf(), $st_nom_intv2, $cjt_intv2->getIdf(), $st_nom_cjt_intv2);
                            }
