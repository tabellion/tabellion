...
print("<script src='../assets/js/CalRep.js' type='text/javascript'></script>");
print("<script src='../assets/iviewer/jquery-ui.min.js' type='text/javascript'></script>");
print("<script src='../assets/iviewer/jquery.mousewheel.min.js' type='text/javascript'></script>");
print("<script src='../assets/iviewer/jquery.iviewer.js' type='text/javascript'></script>");
print("<link href='../assets/iviewer/jquery.iviewer.css' type='text/css' rel='stylesheet'>");
