...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="btn-group col-md-offset-3 col-md-6" role="group">
                <a class="btn btn-primary" href="/recherche.php" role="button"><span class="glyphicon glyphicon-search"></span> Revenir à la page de recherche</a>
                <a class="btn btn-warning" href="/recherche.php?recherche=nouvelle" role="button">
