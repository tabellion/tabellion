...
if ($gst_mode=='COMPARAISON')
{
	...
	if (!move_uploaded_file($_FILES['AdhtsCGCP']['tmp_name'],$st_fich_dest)) 
    {
        ...
        { 
            case 2 : print("<div class='alert'Fichier trop gros par rapport &agrave; MAX_FILE_SIZE</div>");break;
            default : print("<div class='alert'Erreur inconnue</div>");print_r($_FILES);
        }
        exit;
    }
	...
	fputcsv($fh,array('Année inscription CGCP','Adht','Age','Email','Année cotisation CGCP','Dernière connexion CGCP','Absence CGCP (en J)','Statut AGC','Dernière connexion AGC','Absence AGC (en J)','Année cotisation AGC'),';'); 
