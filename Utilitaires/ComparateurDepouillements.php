...
$ga_nom_commune_cgcp_vers_insee_agc = array(
    ...
    'Eraville' => 161290,
    'Fleurignac' => 163791,
    'For�t-de-Tess�-La' => 161420,
    'Grand-Madieu-Le' => 161570,
    'Graves' => 162971,
    'Juillaguet' => 161720,
    'Lam�rac' => 161790,
    'Laplaud' => 162882,
    'L�zignac-sur-Goire' => 163372,
    'Louzac' => 161932,
    'Louzac-Saint-Andr�' => 161931,
    'Loubert' => 162883,
    'Magdeleine' => 161162,
    ...
    'Saint-M�dard-de-Rouillac' => 163392,
    'Saint-Paul' => 164051,
    'Saint-Projet' => 163442,
    'Saint-Quentin-le-Br�l�' => 161821,
...
<h3 align=\"left\">        
      ...
      <p align=\"left\">Les table d&eacute;c&eacute;nnales de mariage de l'AGC sont consultables librement sur son site. Celles du CGCP sont r&eacute;serv&eacute;es aux adh�rents (relev&eacute;s non filiatifs)              
      </p>          
      <p align=\"left\">La liste des communes de r�f�rence est la liste du CGCP pour la Charente.       
        <br>Pour chaque commune du CGCP, une tentative de correspondance avec une commune de l'AGC est faite.       
        <br>Par contre, si l'AGC a effectu� le d�pouillement d'une commune qui n'est pas connue du CGCP, celle-ci ne figure pas dans le comparatif (Exemple: ANGOULEME (St Martial))        
        <br>Les fourchettes affich&eacute;es correspondent aux ann&eacutees de d�but et de fin. Consulter les d&eacute;pouillements de chaque site pour voir les &eacute;ventuels trous
      </p>
      <p align=\"left\">
      Une liste des d�pouillements par canton est �galement disponible aux liens ci-dessous :
      </p>";

    //Angouleme
    $st_page .= "<div align=\"left\">";
    $i = 0;
    $st_page .= "<h2 align=center><font color=coral>Arrondissement d'Angoul�me</font></h2>";
    $st_page .= "<ul>";
    ...
    $st_page .= '<h2 align=center><font color=coral>Arrondissement de Confolens (zone de "pr�dilection" du CGCP)</font></h2>';
    //Confolens
    $st_page .= "<div align=\"left\">";
    $i = 0;
    $st_page .= "<ul>";
    ...
    $st_page .= "<h2 align=center><font color=coral>Arrondissement d'Angoul�me </font></h3>";
    $i = 0;
    ...
    $st_page .= '<h2 align=center><font color=coral>Arrondissement de Confolens (Zone de "pr�dilection" du CGCP)</font></h3>';
    $i = 0;
...
function tableau_comparaison($pa_insee)
{
    ...
    $st_tableau .= '<th rowspan=2>Code Insee</th><th rowspan=2>Commune</th><th colspan=2>Naissances</th><th colspan=2>Mariages filiatifs</th><th colspan=2>Divers filiatifs</th><th colspan=2>D�c�s</th><th rowspan=2>Nb CM AGC</th><th colspan=2>Nb total<br>d\'actes</th>';
    $st_tableau .= '</tr><tr>';
