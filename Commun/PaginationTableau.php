    ...
    public function affiche_tableau_edition($pst_nom_script = '', $pi_type_identifiant = 1, $pb_conversion_encodage = true)
    {
        ...
        foreach ($a_lignes as $a_ligne) {
            ...
            switch ($pi_type_identifiant) {
                case 1:
                    print(sprintf("<td><a class=\"btn btn-primary btn-block\" type=button id=\"bouton%d\" href=\"%s?mod=%d\" role=\"button\"><span class=\"glyphicon glyphicon-edit\"></span> Modifier</a></td>", $idf_element, $pst_nom_script, $idf_element));
                    break;
                case 2:
                    print(sprintf("<td><a class=\"btn btn-primary btn-block\" type=button id=\"bouton%d\" href=\"%s?mod=%s\" role=\"button\"><span class=\"glyphicon glyphicon-edit\"></span> Modifier</a></td>", $idf_element, $pst_nom_script, $idf_element));
                    break;
                default:
    ...
    public function affiche_tableau_edition_sil($pi_type_identifiant = 1)
    {
        ...
        foreach ($a_lignes as $a_ligne) {
            ...
            switch ($pi_type_identifiant) {
                case 1:
                    print(sprintf(
                        "<td><a class='btn btn-primary btn-sm btn-block' type='button' id=\"bouton%d\" href=\"%s?mod=%d\" role='button'><span class='glyphicon glyphicon-edit'></span> Modifier</a></td>",
                        $idf_element,
                ...
                case 2:
                    print(sprintf(
                        "<td><a class='btn btn-primary btn-sm btn-block' type='button' id=\"bouton%s\" href=\"%s?mod=%s\" role='button'><span class='glyphicon glyphicon-edit'></span> Modifier</a></td>",
                        $idf_element,
                        basename(filter_input(INPUT_SERVER, 'SCRIPT_NAME', FILTER_SANITIZE_STRING)),
                        $idf_element
                    ));
