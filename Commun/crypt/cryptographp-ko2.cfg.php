...
$charG = 150;     // Couleur des caractères au format RGB: Green (0->255)
...
$charsizemin = 20;      // Taille minimum des caractères
...
$noisepxmin = 100;      // Bruit: Nb minimum de pixels aléatoires
$noisepxmax = 100;      // Bruit: Nb maximum de pixels aléatoires
...
$brushsize = 25;        // Taille d'ecriture du princeaiu (en pixels) 
