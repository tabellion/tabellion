<?php
// Paramètres Site
$gst_url_site = "http://basev4.test";
$gst_rep_site = "C:/laragon/www/basev4";
$gst_emails_gestbase = "fbouffanet@yahoo.fr";
$gst_url_sortie = "http://basev4.test";
// Paramètres Base de données
$gst_serveur_bd = "localhost";
$gst_utilisateur_bd = "userao";
$gst_mdp_utilisateur_bd = "userao";
$gst_nom_bd = "assoactes";

// Paramètres Généabank
$gst_administrateur_gbk = "";
$gst_mdp_administrateur_gbk = "";
$gst_url_interrogation_geneabank = "";
$gst_url_reponse_gbk = "";
$gst_url_indexes_geneabank = "";
