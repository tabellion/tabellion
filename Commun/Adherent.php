...
class Adherent
{
	...
	*/
    ...
    public function __construct($pconnexionBD, $pi_idf_adherent)
    {
        ...
        $this->a_filtres_parametres["email_forum"] = array(
            array("required", "true", "L'email est obligatoire", ""),
        ...
        $this->a_filtres_parametres["email_perso"] = array(
            array("required", "true", "L'email est obligatoire", ""),
            array("email", "true", "Ce n'est pas un email", "")
        );
        $this->a_filtres_parametres["date_premiere_adhesion"] = array(array("dateITA", "true", "Ce n'est pas une date", ""));
        $this->a_filtres_parametres["date_paiement"] = array(
            array("required", "true", "La date de paiement est obligatoire", ""),
            array("dateITA", "true", "Ce n'est pas une date", "")
        );
        $this->a_filtres_parametres["prix"] = array(
            array("required", "true", "Le prix est obligatoire", ""),
        ...
        $this->a_filtres_parametres["annee_cotisation"] = array(
            array("required", "true", "L'annèe de cotisation est obligatoire", ""),
        ...
        $this->a_filtres_parametres["max_nai"] = array(
            array("required", "true", "Le quota de naissance est obligatoire", ""),
            array("number", "true", "Le quota de naissance est un entier", "")
        );
        $this->a_filtres_parametres["max_mar_div"] = array(
            array("required", "true", "Le quota de mariage/divers est obligatoire", ""),
            array("number", "true", "Le quota de mariage/divers est un entier", "")
        );
        $this->a_filtres_parametres["max_dec"] = array(
            array("required", "true", "Le quota de décès est obligatoire", ""),
